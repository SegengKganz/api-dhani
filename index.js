...
app.listen(PORT, () => {
    ...
    console.log(color("> Rest api ini dibuat oleh ``GengOfficiall``",'white'))
    console.log(color("> Buy rest api no pasaran bisa beli di GengOfficial,",'white'))
    console.log(color("> Whatsapp :","red"), color("\n › no : 62838-4667-7065\n › link : https://wa.me/6283846677065",'white'))
    console.log(color("> Instagram :","red"), color("\n › name : @geng_store12\n › link : https://instagram.com/@geng_store12",'white'))
